...
const CreatePost = () => {
    ...
    async function handlePost() {
        try {
            ...
            const response = await fetch('https://hexagon-backend.onrender.com/post', {
                method: 'POST',
                body: formData,
            });
        ...
        <div className="create-post-container">
            ...
            <div className="create-post-content">
                ...
                <div className="post-form">
                    ...
                    <input type="file" onChange={handlePicture} style={{ display: 'none' }} ref={fileInputRef} />
                    <div className="icon-group">
                        <FaImage size={30} className="upload-icon" onClick={handleIcon} />
                        {image && <FaTimes size={20} className="cross-icon" onClick={handleCross} />}
                    </div>
